          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-4 mb-8">
              {[
                ...
                { icon: Download, label: "Education", value: "Ph.D. Stanford" },
              ].map((item) => (
                <div key={item.label} className="flex items-center gap-3 p-3 rounded-xl bg-[#141414] border border-[#2a2a2a]">
            ...
            <div className="flex flex-wrap gap-3">
              <a
                href="/resume.pdf"
                download
                className="px-5 py-2.5 bg-gradient-to-r from-indigo-500 to-purple-500 text-white text-sm font-medium rounded-xl hover:opacity-90 transition-all flex items-center gap-2"
              >
                <Download size={14} />
                Download Resume
              </a>
              <a
                href="/#contact"
                className="px-5 py-2.5 border border-[#2a2a2a] text-white text-sm font-medium rounded-xl hover:border-indigo-500/50 hover:bg-indigo-500/5 transition-all flex items-center gap-2"
              >
                <Mail size={14} />
                Get in Touch
              </a>
